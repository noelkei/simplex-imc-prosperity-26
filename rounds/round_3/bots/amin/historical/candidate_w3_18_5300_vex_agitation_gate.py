...
CONFIG = {'bot_id': 'W3-18',
 ...
 'hypothesis': '5300 may only be worth fading when VEX is not already in an agitated state, so VEX '
               'move-ema and anchor-gap should be treated as explicit no-trade conditions.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 8,
               'anchor_alpha': 0.025,
               'cross_pad': 0.4,
               'entry_threshold': 1.0,
