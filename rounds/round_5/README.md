...
Official round facts expected path: `../../docs/prosperity_wiki/rounds/round_5.md`

The official Round 5 facts file is not present in this repository yet. Do not start round work until that curated wiki file exists.
...
1. Confirm `../../docs/prosperity_wiki/rounds/round_5.md` exists.
