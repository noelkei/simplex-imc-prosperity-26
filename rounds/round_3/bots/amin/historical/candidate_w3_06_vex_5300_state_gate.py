...
CONFIG = {'bot_id': 'W3-06',
 ...
 'hypothesis': 'Because vouchers are options linked to VEX, 5300 should only trade when the '
               'underlying is in a calm enough state for residual reversion to matter.',
 'kind': 'voucher',
