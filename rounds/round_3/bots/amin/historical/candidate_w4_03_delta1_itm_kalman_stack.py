...
CONFIG = {'bot_id': 'W4-03',
 ...
 'hypothesis': 'The highest-ROI untested finalist is the W3-23 ITM thesis lifted onto the stronger '
               'W3-15 champion base instead of the older delta-1 control stack.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 3,
               'anchor_alpha': 0.015,
               'cross_pad': 0.22,
               'entry_threshold': 0.9,
