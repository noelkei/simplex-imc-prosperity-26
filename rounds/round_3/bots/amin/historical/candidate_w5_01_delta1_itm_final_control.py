...
CONFIG = {'bot_id': 'W5-01',
 ...
 'hypothesis': 'Freeze the exact W4-03 winner family as the live benchmark so every Wave 5 upside '
               'attempt is judged against the actual strongest clean architecture.',
 'kind': 'voucher',
