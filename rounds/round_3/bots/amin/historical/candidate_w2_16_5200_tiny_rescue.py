...
CONFIG = {'bot_id': 'W2-16',
 ...
 'hypothesis': 'VEV_5200 only deserves one last coverage run as a tiny anchored scalp with harsh '
               'exits, not as a normal promotion candidate.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.3,
               'aggressive_size': 2,
               'anchor_alpha': 0.02,
               'cross_pad': 0.2,
               'entry_threshold': 1.8,
