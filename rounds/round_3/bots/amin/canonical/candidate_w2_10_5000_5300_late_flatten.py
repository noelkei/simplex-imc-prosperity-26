...
CONFIG = {'bot_id': 'W2-10',
 ...
 'hypothesis': 'If the selective active subset mostly loses in the session tail, a no-new-entry '
               'cutoff plus hard flatten should retain more realized edge than the clean retest '
               'variant.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 5,
               'anchor_alpha': 0.02,
               'cross_pad': 0.45,
