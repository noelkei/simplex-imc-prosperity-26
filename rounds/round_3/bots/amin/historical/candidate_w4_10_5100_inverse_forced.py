...
CONFIG = {'bot_id': 'W4-10',
 ...
 'hypothesis': '5100 should either prove itself as a tiny anti-signal when thresholds are low '
               'enough to actually trade, or be closed decisively for final-bot purposes.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 0.75,
               'aggressive_size': 3,
               'anchor_alpha': 0.02,
               'cross_pad': 0.12,
