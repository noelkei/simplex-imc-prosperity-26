"""
r4_final_10 — No Flow Filter (Flow Logic Disabled)
=====================================================
Variant of 05. Single change: counterparty flow blocking is fully
disabled. block_buy / block_sell always False, no clip changes from
flow. Hypothesis: the flow filter may be misreading signals and
...
class Trader:
    ...
    def _trade_otm(
        ...
        # Flow-based adjustments — DISABLED in this variant
        block_buy = False
        block_sell = False
        # (flow logic removed: no blocking, no clip changes from flow)
