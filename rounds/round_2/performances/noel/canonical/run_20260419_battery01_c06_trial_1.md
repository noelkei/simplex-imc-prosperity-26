# run_20260419_battery01_c06_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c06_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
- Candidate ID: `R2-CAND-06`
- Variant ID: `trial_1`
- Decision relevance: `canonical`
- Bot path: [`rounds/round_2/bots/noel/canonical/candidate_r2_cand_06_aco_full_book_depth_backup.py`](../../../../rounds/round_2/bots/noel/canonical/candidate_r2_cand_06_aco_full_book_depth_backup.py)
- Strategy spec: [`spec_r2_cand_06_aco_full_book_depth_backup.md`](../../../workspace/04_strategy_specs/spec_r2_cand_06_aco_full_book_depth_backup.md)
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_06_aco_full_book_depth_backup.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_06_aco_full_book_depth_backup.json)
- Data day / source: Round 2 platform test JSON, day `1`, randomized 80% quote subset
- Changed axis: `ACO full-book/depth`
- Expected effect based on EDA/understanding: `ACO full-book/depth` should improve execution or alpha if the online proxy activates.
...
- Strategy family: `aco_full_book`
- Tested feature / signal: `ACO full-book/depth`
- Changed axis type: `feature toggle / execution`
- Dedup key: `aco_full_book + ACO full-book/depth + platform day 1 randomized subset + real platform PnL`
...
| --- | --- | --- | --- | --- | --- |
| `ACO full-book/depth` | Improve PnL or isolate evidence | Total PnL `0.000`, IPR `0.000`, ACO `0.000` | platform product attribution | `down for current ACO implementation` | `reject current implementation` |
