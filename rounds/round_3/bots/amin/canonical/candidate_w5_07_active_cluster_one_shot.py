...
CONFIG = {'bot_id': 'W5-07',
 ...
 'hypothesis': 'One slot should still ask whether the old active cluster can retain meaningful '
               'upside on its own once continuation is brutally constrained to almost one-shot '
               'behavior.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 1,
               'anchor_alpha': 0.02,
               'cross_pad': 0.18,
