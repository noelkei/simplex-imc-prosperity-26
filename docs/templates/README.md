...
- `understanding_template.md`: phase 02 understanding summaries.
- `eda_summary_template.md`: phase 01 EDA summaries.
- `strategy_candidates_template.md`: phase 03 candidate generation and shortlisting.
