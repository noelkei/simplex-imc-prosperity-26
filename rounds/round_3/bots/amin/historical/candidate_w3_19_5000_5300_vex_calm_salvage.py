...
CONFIG = {'bot_id': 'W3-19',
 ...
 'hypothesis': 'If the old high-peak subset had any real residual edge, the fairest remaining way '
               'to see it is inside a tight early window and only when VEX itself is calm enough.',
 'kind': 'voucher',
