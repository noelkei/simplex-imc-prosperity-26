"""
r4_final_09 — Wider Spread Filter (Relaxed max_spread)
=====================================================
Variant of 05. Single change: max_spread widened for all strikes.
Hypothesis: the base bot filters out too many opportunities by
requiring tight spreads; relaxing this captures more trades.
"""
...
STRIKE_CONFIG = {
    "VEV_5200": {"vex_sens": 0.75, "base_clip": 14, "max_spread": 10, "edge": 0.5},
    "VEV_5300": {"vex_sens": 0.60, "base_clip": 16, "max_spread": 8, "edge": 0.5},
    "VEV_5400": {"vex_sens": 0.35, "base_clip": 20, "max_spread": 6, "edge": 0.3},
    "VEV_5500": {"vex_sens": 0.18, "base_clip": 22, "max_spread": 5, "edge": 0.2},
}
RD4_DAYS_LEFT = 4.0
