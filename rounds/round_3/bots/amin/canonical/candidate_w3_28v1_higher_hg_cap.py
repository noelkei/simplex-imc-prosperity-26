"""
W3-28v1: Higher HYDRO Capacity + Tighter Take Edge
====================================================
Base: W3-28 (+1,168)
Changes:
  - HG_CAP: 130 → 155 (use more of the 200 limit; HYDRO is the main PnL driver)
  - HG_TEDGE: 3 → 2 (take liquidity more aggressively — fill on smaller deviations)
  - HG_TSZ: 18 → 22 (larger aggressive takes when edge detected)
  - HG_PSZ: 24 → 28 (larger passive quotes to capture more spread)

Rationale: The PnL curve shows HYDRO MM is the engine. More capacity + tighter
takes should increase fill rate and spread capture. Risk: larger positions mean
bigger swings, but the exponential penalty should contain extremes.
...
HG_CAP = 155; VEX_CAP = 120       # ← UP from 130
HG_HALF = 3; VEX_HALF = 2
HG_PSZ = 28; VEX_PSZ = 15         # ← UP from 24
HG_TSZ = 22; VEX_TSZ = 12         # ← UP from 18
HG_TEDGE = 2; VEX_TEDGE = 2       # ← DOWN from 3
