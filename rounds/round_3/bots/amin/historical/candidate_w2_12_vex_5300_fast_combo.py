...
CONFIG = {'bot_id': 'W2-12',
 ...
 'hypothesis': 'The descriptive VEX plus 5300 winner from Wave 1 should become more robust if the '
               'voucher leg is explicitly run as a fast-unwind addon instead of a hold leg.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.8,
               'aggressive_size': 7,
               'anchor_alpha': 0.025,
               'cross_pad': 0.35,
               'entry_threshold': 1.0,
