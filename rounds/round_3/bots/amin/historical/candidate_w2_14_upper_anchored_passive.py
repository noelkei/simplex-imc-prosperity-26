...
CONFIG = {'bot_id': 'W2-14',
 ...
 'hypothesis': 'The upper branch still deserves one clean passive anchored refinement before we '
               'decide whether it is a permanent pause or just an execution problem.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 0,
               'anchor_alpha': 0.02,
               'cross_pad': 0.0,
               'entry_threshold': 0.7,
