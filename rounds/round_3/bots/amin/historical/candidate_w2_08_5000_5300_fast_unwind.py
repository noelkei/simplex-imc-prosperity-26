...
CONFIG = {'bot_id': 'W2-08',
 ...
 'hypothesis': 'The best active subset should look materially better if we monetize the early edge '
               'and refuse to let the run drift into late reversals.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 2.1,
               'aggressive_size': 5,
               'anchor_alpha': 0.02,
               'cross_pad': 0.45,
