# run_20260419_battery01_c01_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c01_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
- Candidate ID: `R2-CAND-01`
- Variant ID: `trial_1`
- Decision relevance: `canonical`
- Bot path: [`rounds/round_2/bots/noel/canonical/candidate_r2_cand_01_ipr_drift_fv_maker.py`](../../../../rounds/round_2/bots/noel/canonical/candidate_r2_cand_01_ipr_drift_fv_maker.py)
- Strategy spec: [`spec_r2_cand_01_ipr_drift_fv_maker.md`](../../../workspace/04_strategy_specs/spec_r2_cand_01_ipr_drift_fv_maker.md)
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_01_ipr_drift_fv_maker.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_01_ipr_drift_fv_maker.json)
- Data day / source: Round 2 platform test JSON, day `1`, randomized 80% quote subset
- Changed axis: `IPR drift/residual`
- Expected effect based on EDA/understanding: `IPR drift/residual` should improve execution or alpha if the online proxy activates.
...
- Status: `FINISHED`
- Profit / score: `559.000`
- Runtime issues: none visible in platform JSON
- Rejections or errors: not available in JSON
- Position-limit concerns: final IPR `-30`, final ACO `0`; max path position unavailable
...
- Strategy family: `ipr_drift`
- Tested feature / signal: `IPR drift/residual`
- Changed axis type: `feature toggle / execution`
- Dedup key: `ipr_drift + IPR drift/residual + platform day 1 randomized subset + real platform PnL`
- Knowledge delta: `new`
- ROI-gated memory action: `update lightly`
- Memory action rationale: Single low result conflicts with code-equivalent IPR drift family results.
...
- Reroute: `rerun before rejecting`
...
|:---------------------|------------:|-----------------:|-------------------:|
| INTARIAN_PEPPER_ROOT |         559 |              -30 |                972 |
| ASH_COATED_OSMIUM    |           0 |                0 |                  0 |

- Final positions: IPR `-30`, ACO `0`, XIRECS `393556`
- Max drawdown from graphLog: `-332.000`
- Graph min / max: `0.000` / `894.000`
...
| --- | --- | --- | --- | --- | --- |
| `IPR drift/residual` | Improve PnL or isolate evidence | Total PnL `559.000`, IPR `559.000`, ACO `0.000` | platform product attribution | `up` | `rerun before rejecting` |
...
- Continue / promote / debug / discard / revise spec / rerun / stop: `rerun before rejecting`
