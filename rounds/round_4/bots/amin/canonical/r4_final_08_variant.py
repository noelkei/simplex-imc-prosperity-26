"""
r4_final_08 — Aggressive VEX Taking (Edge 0.5)
=====================================================
Variant of 05. Single change: VEX take-edge reduced from 1.5 to 0.5.
Hypothesis: VEX is an anchor product; trading it more aggressively
gives better delta hedging AND captures more small-edge fills.
"""
