...
CONFIG = {'bot_id': 'W3-21',
 ...
 'hypothesis': 'If 5100 only works as an anti-signal, pairing that tiny inverse branch with VEX is '
               'the cleanest practical test of whether the strike belongs in any final '
               'architecture at all.',
 'kind': 'voucher',
