...
CONFIG = {'bot_id': 'W3-03',
 ...
 'hypothesis': 'The strongest historical VEX plus ITM family should survive better if ITM is '
               'refreshed as a lightly active overlay rather than as passive dead weight.',
 'kind': 'voucher',
