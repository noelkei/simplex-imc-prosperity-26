# run_20260419_battery01_c05_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c05_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
- Candidate ID: `R2-CAND-05`
- Variant ID: `trial_1`
- Decision relevance: `canonical`
- Bot path: [`rounds/round_2/bots/noel/canonical/candidate_r2_cand_05_aco_microprice_challenger.py`](../../../../rounds/round_2/bots/noel/canonical/candidate_r2_cand_05_aco_microprice_challenger.py)
- Strategy spec: [`spec_r2_cand_05_aco_microprice_challenger.md`](../../../workspace/04_strategy_specs/spec_r2_cand_05_aco_microprice_challenger.md)
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_05_aco_microprice_challenger.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_05_aco_microprice_challenger.json)
- Data day / source: Round 2 platform test JSON, day `1`, randomized 80% quote subset
- Changed axis: `ACO microprice`
- Expected effect based on EDA/understanding: `ACO microprice` should improve execution or alpha if the online proxy activates.
...
- Strategy family: `aco_microprice`
- Tested feature / signal: `ACO microprice`
- Changed axis type: `feature toggle / execution`
- Dedup key: `aco_microprice + ACO microprice + platform day 1 randomized subset + real platform PnL`
...
| --- | --- | --- | --- | --- | --- |
| `ACO microprice` | Improve PnL or isolate evidence | Total PnL `0.000`, IPR `0.000`, ACO `0.000` | platform product attribution | `down for current ACO implementation` | `reject current implementation` |
