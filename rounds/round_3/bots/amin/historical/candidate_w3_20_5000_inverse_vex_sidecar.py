...
CONFIG = {'bot_id': 'W3-20',
 ...
 'hypothesis': 'If 5000 is better treated as an anti-signal, the most realistic version of that '
               'test is a tiny inverse branch attached to the healthier VEX sidecar.',
 'kind': 'voucher',
