...
CONFIG = {'bot_id': 'W5-02',
 ...
 'hypothesis': 'The current winner should keep more of its path quality if the ITM overlay is '
               'gated earlier, capped in reentries, and forced into a calmer late-session posture.',
 'kind': 'voucher',
