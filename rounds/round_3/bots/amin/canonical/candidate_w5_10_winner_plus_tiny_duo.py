...
CONFIG = {'bot_id': 'W5-10',
 ...
 'hypothesis': 'Removing 5000 may be the cleanest way to ask whether the highest legacy peak '
               'driver, 5100, can still add controlled upside when paired only with 5300 and the '
               'live winner base.',
 'kind': 'voucher',
