"""
r4_final_05 — Full OTM Basket
================================
Approach: The most comprehensive OTM strategy — trades ALL four OTM strikes
(5200-5500) with BS fair value, counterparty flow awareness, VEX anchor MM,
and cross-strike inventory coordination. Each strike gets its own IV tracking
and sensitivity to VEX moves. When Mark 22 selling dominates, activates a
defensive posture across the entire basket. When Mark 01 is buying into
strength, increases clip sizes. Global exposure management prevents
over-concentration in any single strike.
"""
...
STRIKE_CONFIG = {
    "VEV_5200": {"vex_sens": 0.75, "base_clip": 14, "max_spread": 6, "edge": 0.5},
    "VEV_5300": {"vex_sens": 0.60, "base_clip": 16, "max_spread": 5, "edge": 0.5},
    "VEV_5400": {"vex_sens": 0.35, "base_clip": 20, "max_spread": 3, "edge": 0.3},
    "VEV_5500": {"vex_sens": 0.18, "base_clip": 22, "max_spread": 3, "edge": 0.2},
}
RD4_DAYS_LEFT = 4.0
