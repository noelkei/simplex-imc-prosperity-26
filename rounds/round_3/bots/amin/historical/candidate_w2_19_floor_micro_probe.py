...
CONFIG = {'bot_id': 'W2-19',
 ...
 'hypothesis': 'The floor names are probably not directional alpha, but tiny 0/1 passive and '
               'floor-break probing is still the cleanest way to confirm whether any monetizable '
               'microstructure remains.',
 'kind': 'floor',
 'products': [{'allow_short': True,
               'ask_price': 1,
               'bid_price': 0,
               'cross_buy_at_or_below': 0,
               'cross_sell_at_or_above': 1,
               'limit': 300,
               'passive_size': 1,
               'passive_when_spread_at_least': 1,
               'symbol': 'VEV_6000',
               'working_limit': 4},
              {'allow_short': True,
               'ask_price': 1,
