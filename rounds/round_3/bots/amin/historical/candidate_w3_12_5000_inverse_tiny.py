...
CONFIG = {'bot_id': 'W3-12',
 ...
 'hypothesis': 'Because 5000 is negative at every tested horizon in the standard direction, a tiny '
               'inverse diagnostic is now a higher-value test than another normal residual bot.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.1,
               'aggressive_size': 2,
               'anchor_alpha': 0.02,
               'cross_pad': 0.45,
