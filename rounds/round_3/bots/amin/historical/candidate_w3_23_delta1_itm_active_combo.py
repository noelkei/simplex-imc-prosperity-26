...
CONFIG = {'bot_id': 'W3-23',
 ...
 'hypothesis': 'A cleaner version of the strongest historical family may be delta-1 first with a '
               'smaller, more active ITM overlay rather than passive ITM or voucher-heavy '
               'composites.',
 'kind': 'voucher',
