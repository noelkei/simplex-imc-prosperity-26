...
CONFIG = {'bot_id': 'W3-17',
 ...
 'hypothesis': '5300 may keep more of its edge if it only takes residual trades that agree with '
               'local order-book pressure instead of fading every extreme equally.',
 'kind': 'voucher',
