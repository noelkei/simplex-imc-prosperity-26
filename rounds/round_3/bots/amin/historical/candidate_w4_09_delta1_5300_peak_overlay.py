...
CONFIG = {'bot_id': 'W4-09',
 ...
 'hypothesis': 'If any old voucher-led upside is still worth borrowing, the safest place to borrow '
               'it is as a tiny early-shutdown 5300 overlay on top of the champion base.',
 'kind': 'voucher',
