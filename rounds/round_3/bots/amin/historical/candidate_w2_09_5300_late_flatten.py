...
CONFIG = {'bot_id': 'W2-09',
 ...
 'hypothesis': 'The main 5300 problem may be session-tail toxicity rather than entry quality, so '
               'shutting the branch down late should preserve more of the path peak.',
 'kind': 'voucher',
