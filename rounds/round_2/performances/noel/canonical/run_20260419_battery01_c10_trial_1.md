# run_20260419_battery01_c10_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c10_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
- Candidate ID: `R2-CAND-10`
- Variant ID: `trial_1`
- Decision relevance: `canonical`
- Bot path: [`rounds/round_2/bots/noel/canonical/candidate_r2_cand_10_maf_bid_policy.py`](../../../../rounds/round_2/bots/noel/canonical/candidate_r2_cand_10_maf_bid_policy.py)
- Strategy spec: [`spec_r2_cand_10_maf_bid_policy.md`](../../../workspace/04_strategy_specs/spec_r2_cand_10_maf_bid_policy.md)
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_10_maf_bid_policy.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_10_maf_bid_policy.json)
- Data day / source: Round 2 platform test JSON, day `1`, randomized 80% quote subset
- Changed axis: `IPR drift + ACO imbalance + bid placeholder`
- Expected effect based on EDA/understanding: `IPR drift + ACO imbalance + bid placeholder` should improve execution or alpha if the online proxy activates.
...
- Status: `FINISHED`
- Profit / score: `2659.906`
- Runtime issues: none visible in platform JSON
- Rejections or errors: not available in JSON
- Position-limit concerns: final IPR `11`, final ACO `0`; max path position unavailable
...
- Strategy family: `maf_policy_probe`
- Tested feature / signal: `IPR drift + ACO imbalance + bid placeholder`
- Changed axis type: `feature toggle / execution`
- Dedup key: `maf_policy_probe + IPR drift + ACO imbalance + bid placeholder + platform day 1 randomized subset + real platform PnL`
- Knowledge delta: `new`
...
|:---------------------|------------:|-----------------:|-------------------:|
| INTARIAN_PEPPER_ROOT |     2659.91 |               11 |                900 |
| ASH_COATED_OSMIUM    |        0    |                0 |                  0 |

- Final positions: IPR `11`, ACO `0`, XIRECS `-141439`
- Max drawdown from graphLog: `0.000`
- Graph min / max: `0.000` / `2658.797`
...
| --- | --- | --- | --- | --- | --- |
| `IPR drift + ACO imbalance + bid placeholder` | Improve PnL or isolate evidence | Total PnL `2659.906`, IPR `2659.906`, ACO `0.000` | platform product attribution | `up for IPR / down for ACO activation` | `promote to rerun/variant` |
