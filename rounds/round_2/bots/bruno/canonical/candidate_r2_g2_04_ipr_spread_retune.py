...
CONFIG = {'bot_id': 'R2-G2-04-IPR-SPREAD-RETUNE', 'role': 'ipr_spread_retune', 'modes': ['ipr_spread_retune'], 'maf_bid': 0, 'inventory_soft': 40, 'ipr_clip': 6, 'ipr_extreme_threshold': 2.0, 'ipr_threshold': 1.0, 'ipr_slope_alpha': 0.05, 'ipr_warmup': 20, 'ipr_max_spread': 18, 'aco_clip': 5, 'aco_probe_clip': 3, 'aco_quote_clip': 8, 'aco_max_spread': 21, 'aco_full_spread': 16, 'aco_mid_spread': 18, 'aco_mid_mult': 0.65, 'aco_wide_mult': 0.35, 'aco_quote_offset': 5, 'aco_half_spread': 5, 'aco_inventory_skew': 3, 'aco_aggression': 0.58, 'aco_probe_take_edge': 5.0, 'imbalance_threshold': 0.12, 'ipr_continuous_spread': True, 'ipr_full_spread': 4, 'ipr_mid_spread': 14, 'ipr_mid_mult': 0.5, 'ipr_wide_mult': 0.25, 'ipr_spread_penalty': 0.08}
