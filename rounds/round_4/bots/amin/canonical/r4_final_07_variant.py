"""
r4_final_07 — Bigger Clips (60% Larger Clip Sizes)
=====================================================
Variant of 05. Single change: all base_clip values increased ~60%.
Hypothesis: the base bot trades too small per fill; bigger clips
capture more when edge exists.
"""
...
STRIKE_CONFIG = {
    "VEV_5200": {"vex_sens": 0.75, "base_clip": 22, "max_spread": 6, "edge": 0.5},
    "VEV_5300": {"vex_sens": 0.60, "base_clip": 26, "max_spread": 5, "edge": 0.5},
    "VEV_5400": {"vex_sens": 0.35, "base_clip": 32, "max_spread": 3, "edge": 0.3},
    "VEV_5500": {"vex_sens": 0.18, "base_clip": 35, "max_spread": 3, "edge": 0.2},
}
RD4_DAYS_LEFT = 4.0
