...
- Before promoting a paper beyond `papers_raw/`, normalize naming, assign a stable `paper_id`, track input type (`pdf | latex_source | mixed`), and ensure a usable `papers_md` file with fidelity and caveats exists.
