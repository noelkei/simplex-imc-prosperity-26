# run_20260419_battery01_c09_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c09_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
- Candidate ID: `R2-CAND-09`
- Variant ID: `trial_1`
- Decision relevance: `canonical`
- Bot path: [`rounds/round_2/bots/noel/canonical/candidate_r2_cand_09_spread_defensive_overlay.py`](../../../../rounds/round_2/bots/noel/canonical/candidate_r2_cand_09_spread_defensive_overlay.py)
- Strategy spec: [`spec_r2_cand_09_spread_defensive_overlay.md`](../../../workspace/04_strategy_specs/spec_r2_cand_09_spread_defensive_overlay.md)
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_09_spread_defensive_overlay.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_09_spread_defensive_overlay.json)
- Data day / source: Round 2 platform test JSON, day `1`, randomized 80% quote subset
- Changed axis: `IPR drift + ACO imbalance + spread overlay`
- Expected effect based on EDA/understanding: `IPR drift + ACO imbalance + spread overlay` should improve execution or alpha if the online proxy activates.
...
- Status: `FINISHED`
- Profit / score: `862.297`
- Runtime issues: none visible in platform JSON
- Rejections or errors: not available in JSON
- Position-limit concerns: final IPR `-3`, final ACO `0`; max path position unavailable
...
- Strategy family: `spread_defensive_overlay`
- Tested feature / signal: `IPR drift + ACO imbalance + spread overlay`
- Changed axis type: `feature toggle / execution`
- Dedup key: `spread_defensive_overlay + IPR drift + ACO imbalance + spread overlay + platform day 1 randomized subset + real platform PnL`
- Knowledge delta: `new`
- ROI-gated memory action: `update`
- Memory action rationale: Spread defensive overlay underperformed and likely throttled usable IPR fills.
...
|:---------------------|------------:|-----------------:|-------------------:|
| INTARIAN_PEPPER_ROOT |     862.297 |               -3 |                927 |
| ASH_COATED_OSMIUM    |       0     |                0 |                  0 |

- Final positions: IPR `-3`, ACO `0`, XIRECS `40162`
- Max drawdown from graphLog: `-72.000`
- Graph min / max: `0.000` / `911.812`
...
| --- | --- | --- | --- | --- | --- |
| `IPR drift + ACO imbalance + spread overlay` | Improve PnL or isolate evidence | Total PnL `862.297`, IPR `862.297`, ACO `0.000` | platform product attribution | `up for IPR / down for ACO activation` | `revise overlay` |
...
- Continue / promote / debug / discard / revise spec / rerun / stop: `revise overlay`
