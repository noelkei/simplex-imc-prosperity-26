...
CONFIG = {'bot_id': 'W2-17',
 ...
 'hypothesis': 'The active-to-upper transition may only monetize when 5300 carries the branch and '
               'the upper names are treated as passive anchored satellites.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.7,
               'aggressive_size': 6,
               'anchor_alpha': 0.025,
               'cross_pad': 0.35,
               'entry_threshold': 1.0,
