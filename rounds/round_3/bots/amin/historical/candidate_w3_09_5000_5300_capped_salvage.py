...
CONFIG = {'bot_id': 'W3-09',
 ...
 'hypothesis': 'The only remaining fair test for keeping 5000 alive is a tiny early-window salvage '
               'design that never lets the subset grow into a late-session problem.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 2,
               'anchor_alpha': 0.02,
               'cross_pad': 0.45,
               'entry_threshold': 1.45,
               'giveback_activation': 0.4,
               'giveback_stop': 0.55,
