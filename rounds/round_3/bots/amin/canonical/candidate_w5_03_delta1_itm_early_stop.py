...
CONFIG = {'bot_id': 'W5-03',
 ...
 'hypothesis': 'If late churn is the remaining drag, a stricter early-stop version of the winner '
               'stack should sacrifice little core edge while reducing the worst end-of-run '
               'giveback patterns.',
 'kind': 'voucher',
