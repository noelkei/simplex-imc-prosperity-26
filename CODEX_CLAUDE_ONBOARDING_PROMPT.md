...
- rounds/round_X/research/ = papers externos subidos y sus resúmenes procesados
...
6. Cómo encaja la fase `02b External Paper Research` entre understanding y strategy, incluyendo que el prompt se genera por defecto, se puede usar búsqueda online controlada para shortlist / metadata sin romper trazabilidad, los inputs canónicos siguen siendo locales en `papers_raw/`, y strategy no espera al pipeline completo de papers.
7. Cómo se continúa una fase.
8. Cómo se cierra una fase correctamente.
9. Cómo se usan _index.md y los phase_*_context.md.
10. Cómo colaboran humanos y agentes Codex/Claude en este repo.
11. En qué estado está ahora mismo el repo.
12. Qué tocaría hacer ahora mismo si quiero continuar de forma segura.
13. Qué blockers, riesgos o decisiones humanas hay, si los hay.
...
- rounds/round_X/research/ = uploaded external papers and their processed summaries
...
6. How the `02b External Paper Research` phase fits between understanding and strategy, including that the prompt is generated by default, controlled online search may be used for shortlist-building / metadata without breaking traceability, canonical inputs still remain local in `papers_raw/`, and strategy does not wait for the full paper pipeline.
7. How to continue a phase.
8. How to close a phase correctly.
9. How _index.md and phase_*_context.md are used.
10. How humans and Codex/Claude agents should collaborate in this repo.
11. What state the repository is in right now.
12. What should be done next if I want to continue safely.
13. What blockers, risks, or human decisions exist, if any.
