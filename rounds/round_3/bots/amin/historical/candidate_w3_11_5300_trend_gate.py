...
CONFIG = {'bot_id': 'W3-11',
 ...
 'hypothesis': '5300 should stop fading strong VEX trend states and only take residual trades when '
               'the underlying slope is mild enough to allow mean reversion.',
 'kind': 'voucher',
