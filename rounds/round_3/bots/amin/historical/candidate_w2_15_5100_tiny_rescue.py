...
CONFIG = {'bot_id': 'W2-15',
 ...
 'hypothesis': 'VEV_5100 only deserves one last chance as a tiny fast-unwind scalp attached to a '
               'healthier VEX anchor, not as a normal active strike.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.2,
               'aggressive_size': 2,
               'anchor_alpha': 0.02,
               'cross_pad': 0.2,
