...
CONFIG = {'bot_id': 'W4-04',
 ...
 'hypothesis': 'If ITM is truly additive, a stricter calmer-state version should stay positive '
               'while reducing overlay noise and limiting slippage-sensitive entries.',
 'kind': 'voucher',
