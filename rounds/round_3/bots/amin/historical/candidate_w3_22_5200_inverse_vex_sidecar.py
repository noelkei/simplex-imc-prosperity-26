...
CONFIG = {'bot_id': 'W3-22',
 ...
 'hypothesis': '5200 is toxic enough that it deserves one last tiny inverse test with VEX support '
               'before we close it decisively or keep a microscopic contrarian role alive.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 1.0,
               'aggressive_size': 2,
               'anchor_alpha': 0.02,
               'cross_pad': 0.22,
