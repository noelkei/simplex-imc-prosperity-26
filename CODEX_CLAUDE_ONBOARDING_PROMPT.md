...
6. Cómo encaja la fase `02b External Paper Research` entre understanding y strategy, incluyendo que el prompt se genera por defecto y strategy no espera al pipeline completo de papers.
...
6. How the `02b External Paper Research` phase fits between understanding and strategy, including that the prompt is generated by default and strategy does not wait for the full paper pipeline.
