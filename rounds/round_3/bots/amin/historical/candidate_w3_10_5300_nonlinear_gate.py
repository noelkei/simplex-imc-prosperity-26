...
CONFIG = {'bot_id': 'W3-10',
 ...
 'hypothesis': 'A transformed threshold that scales with VEX agitation and local spread should '
               'keep 5300 out of the states that currently look expensive to fade.',
 'kind': 'voucher',
