...
CONFIG = {'bot_id': 'W3-05',
 ...
 'hypothesis': 'A large part of the 5300 problem is likely re-giving profits after local progress, '
               'so a giveback halt plus cooldown should preserve more path quality.',
 'kind': 'voucher',
