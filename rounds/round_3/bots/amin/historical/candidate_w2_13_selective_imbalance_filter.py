...
CONFIG = {'bot_id': 'W2-13',
 ...
 'hypothesis': 'The selective active subset should keep more of its path edge if we only take '
               'residual trades that are confirmed by local order-book pressure.',
 'kind': 'voucher',
 'products': [{'adverse_move_stop': 2.0,
               'aggressive_size': 5,
               'anchor_alpha': 0.02,
