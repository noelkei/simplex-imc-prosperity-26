...
Batch spec: spec_learning_batch_wave4.md
Bot ID: W4-12
...
CONFIG = {'bot_id': 'W4-12',
 ...
 'hypothesis': 'The last meaningful 5300 comparison is whether a cleaner trend-led gate beats the '
               'imbalance-led branch once both are given similarly disciplined timing and giveback '
               'control.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 6,
               'anchor_alpha': 0.025,
               'buy_vex_slope_min': -0.2,
               'cross_pad': 0.35,
               'entry_threshold': 1.0,
