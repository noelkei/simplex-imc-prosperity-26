...
CONFIG = {'bot_id': 'W4-11',
 ...
 'hypothesis': 'A slightly calmer, smaller, more defensive version of the champion is worth one '
               'slot so we do not over-commit to a single lucky sizing/execution shape.',
 'kind': 'delta1',
 'products': [{'aggressive_size': 10,
               'edge': 2,
               'fair_mode': 'kalman',
