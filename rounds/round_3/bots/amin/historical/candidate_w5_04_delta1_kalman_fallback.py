...
CONFIG = {'bot_id': 'W5-04',
 ...
 'hypothesis': 'Wave 5 still needs a pure-delta benchmark so that every upside-distillation branch '
               'is judged against both the winner stack and the cleanest conservative fallback.',
 'kind': 'delta1',
