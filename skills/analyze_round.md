...
6. Do not infer missing limits or behavior from `bots/`, `performances/`, examples, or memory.
7. Handoff a concise summary with sources, caveats, and concrete next actions.
