...
CONFIG = {'bot_id': 'W3-16',
 ...
 'hypothesis': 'If raw VEX mid is too noisy as an option anchor, a Kalman-smoothed VEX reference '
               'may make the 5300 residual trade cleaner without changing the family thesis.',
 'kind': 'voucher',
