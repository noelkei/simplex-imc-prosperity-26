...
CONFIG = {'bot_id': 'W4-01',
 ...
 'hypothesis': 'Freeze the current clean champion architecture in final-wave form so every other '
               'Wave 4 slot is measured against the real best base we currently have.',
 'kind': 'delta1',
