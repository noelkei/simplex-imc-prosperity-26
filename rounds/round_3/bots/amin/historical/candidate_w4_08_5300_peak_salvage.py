...
CONFIG = {'bot_id': 'W4-08',
 ...
 'hypothesis': 'The cleanest sustainable descendant of the old >10k paths is a one-strike 5300 '
               'salvage bot that stops opening risk early and exits hard once the useful window '
               'ends.',
 'kind': 'voucher',
 'products': [{'aggressive_size': 4,
               'anchor_alpha': 0.025,
