...
CONFIG = {'bot_id': 'W5-05',
 ...
 'hypothesis': 'The highest-ceiling legacy branch should be retested only in a VEX-anchored, '
               'strike-pruned, retention-disciplined form without reopening 5200 or the broad '
               'basket.',
 'kind': 'voucher',
