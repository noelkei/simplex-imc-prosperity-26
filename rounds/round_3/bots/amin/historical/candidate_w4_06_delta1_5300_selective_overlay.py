...
CONFIG = {'bot_id': 'W4-06',
 ...
 'hypothesis': '5300 only deserves final-bot scope if a much smaller W3-17-style overlay can help '
               'the champion without meaningfully contaminating base quality.',
 'kind': 'voucher',
