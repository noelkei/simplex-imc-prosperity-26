# run_20260419_battery01_c08_trial_1

## Run Metadata

- Run ID: `run_20260419_battery01_c08_trial_1`
- Date: `2026-04-19`
- Round: `round_2`
- Member / owner: `noel`
...
- Raw artifact path: [`rounds/round_2/performances/noel/historical/candidate_r2_cand_08_combined_ipr_aco_reversal.json`](../../../../rounds/round_2/performances/noel/historical/candidate_r2_cand_08_combined_ipr_aco_reversal.json)
...
- Status: `FINISHED`
- Profit / score: `1669.594`
- Runtime issues: none visible in platform JSON
- Rejections or errors: not available in JSON
- Position-limit concerns: final IPR `-6`, final ACO `0`; max path position unavailable
...
|:---------------------|------------:|-----------------:|-------------------:|
| INTARIAN_PEPPER_ROOT |     1669.59 |               -6 |                903 |
| ASH_COATED_OSMIUM    |        0    |                0 |                  0 |

- Final positions: IPR `-6`, ACO `0`, XIRECS `80269`
- Max drawdown from graphLog: `-66.000`
- Graph min / max: `0.000` / `1684.594`
...
| --- | --- | --- | --- | --- | --- |
| `IPR drift + ACO reversal` | Improve PnL or isolate evidence | Total PnL `1669.594`, IPR `1669.594`, ACO `0.000` | platform product attribution | `up for IPR / down for ACO activation` | `backup / rerun only if reversal remains interesting` |
